...
const createVendorProduct = async (req, res) => {
  try {
    ...
    const product = await Product.create({
      ...
      size: size?.trim(),
      color: color?.trim(),
      image_1_url: image_1_url?.trim(),
      image_2_url: image_2_url?.trim(),
      image_3_url: image_3_url?.trim(),
      image_1_thumbnail: image_1_thumbnail?.trim(),
      image_2_thumbnail: image_2_thumbnail?.trim(),
      image_3_thumbnail: image_3_thumbnail?.trim(),
