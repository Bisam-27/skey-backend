...
async function createVendorTestData() {
  try {
    ...
    const testOrders = [
      {
        ...
        total_amount: 2598, // 2 * 1299 (t-shirts)
      ...
      },
      {
        ...
        total_amount: 2124, // 1 * 2499 - 15% discount (jeans)
      ...
      },
      {
        ...
        total_amount: 3199, // 1 * 3999 - 20% discount (shoes)
    ...
    console.log(`   - Sales data from order items`);
